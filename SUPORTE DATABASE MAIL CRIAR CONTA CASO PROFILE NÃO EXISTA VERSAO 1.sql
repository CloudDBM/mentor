...
FETCH NEXT FROM CURSOR1 INTO @PROFILE
WHILE @@FETCH_STATUS = 0
BEGIN

	IF @PROFILE <> 'PROFILEMAIL' -- CASO PROFILE DESEJADO NÃO EXISTA
	BEGIN
		SET @CRIAR_PROFILE = 1		
	END
...
IF @CRIAR_PROFILE = 1	-- CRIA NOVO PROFILE
BEGIN
print '1'
	-----------------------------------------------------------------------------------------
	...
	DECLARE
		@Account_Name SYSNAME = 'vpmaciel1@live.com',
		@Profile_Name SYSNAME = 'ProfileEmail'
	...
	EXEC msdb.dbo.sysmail_add_account_sp
		...
		@email_address = 'vpmaciel1@live.com',
		@replyto_address = 'vpmaciel1@live.com',
		@display_name = 'Vicente Paulo Maciel',
		@mailserver_name = 'smtp.office365.com',
		@mailserver_type = 'SMTP',
		@port = '587',
		@username = 'vpmaciel1@live.com',
		@password = 'senha',
		@enable_ssl = 1,
	...
	EXEC msdb.dbo.sysmail_configure_sp 'MaxFileSize', '5242880'; -- 1024 x 1024 x 25
END